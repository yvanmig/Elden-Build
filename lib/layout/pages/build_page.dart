                            ...
                            child: Column(
                                ...
                                children: [
                                  SizedBox(
                                      width: 80,
                                      child: Stat(
                                          value: currentBuild[0].vigor,
                                          name: "VIG")),
                                  SizedBox(
                                    width: 80,
                                    child: Stat(
                                        value: currentBuild[0].mind,
                                        name: "MIND"),
                                  ),
                                  SizedBox(
                                    width: 80,
                                  ...
                                  SizedBox(
                                    width: 80,
                                    child: Stat(
                                        value: currentBuild[0].arcane,
                                        name: "ARC"),
                                  ),
                                  SizedBox(
                                    width: 80,
                                    child: Stat(
                                        value: currentBuild[0].faith,
                                        name: "FAITH"),
                                  ),
                                ]),
                          ),
                                  ...
                                  child: TabBarView(children: <Widget>[
                                    Column(
                                        ...
                                        children: weapons.map((weapon) {
                                          var equipmentImage = Helpers.findById(
                                                  weapons, weapon.id)
                                              .image;
                                          var imgWeapon = weapons.where(
                                              (element) =>
                                                  element.id == weapon.id);
                                          return Equipment(
                                              name: weapon.name,
                                    ...
                                    Column(
                                        ...
                                        children: spells.map((spell) {
                                          var equipmentImage =
                                              Helpers.findById(spells, spell.id)
                                                  .image;
                                          return Container(
                                            child: Equipment(
                                                name: spell.name,
